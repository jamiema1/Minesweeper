...
public class Constants {
    ...
    public static final int INITIAL_BOARD_WIDTH = 10;
    public static final int INITIAL_BOARD_HEIGHT = 10;
    ...
    public static final int SETTINGS_PANEL_HEIGHT = 300;
    public static final int SETTINGS_PANEL_BUTTON_WIDTH = 200;
    public static final int SETTINGS_PANEL_BUTTON_HEIGHT = 50;
    public static final int SETTINGS_PANEL_BUTTON_SPACING = (SETTINGS_PANEL_HEIGHT - 4
            * SETTINGS_PANEL_BUTTON_HEIGHT) / 5;
